    ...
    <v-app v-bind:dark="dark_theme">
      ...
      <Loader  v-if="loader_state > 0" :state="loader_state" max_states="4" name="content"/>
       ...
       <!--<v-content v-if="loader_state === 0"  class="mx-auto"> -->
        ...
        <v-footer color="primary white--text" class="pa-3 text-center">
          <div class="text-center">Réalisé par : Luc Ratelli, Florian Biller, Franck Hubschwerle, Thomas Fritsch et Corentin Jacob</div>
          <v-spacer></v-spacer>
        </v-footer>
      </v-content>
