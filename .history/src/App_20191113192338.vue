    ...
    <v-card-actions>
      ...
      <!--<v-content v-if="loader_state === 0"  class="mx-auto">-->
        ...
        <v-footer color="primary white--text" class="pa-3">
          <div> <img style="max-width: 10%" src="./assets/uha4.0-logo.png" class="imagedroit"><a href="http://www.0.4.uha.fr/" target="_blank" class="white--text">Projet by : Luc Ratelli, Florian Biller, Franck Hubschwerle, Thomas Fritsch et Corentin Jacob.</a> - &copy; {{ new Date().getFullYear() }}</div>
          <v-spacer></v-spacer>
        </v-footer>
      </v-content>
